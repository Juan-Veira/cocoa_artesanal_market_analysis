...
-   **Failure to reject the null:** The trace statistics ($9.58$ for $r = 0$ and $2.29$ for $r \le 1$) are both **below the 5% critical values** ($19.96$ and $9.24$). Because the test statistics do not exceed the critical thresholds, the null hypotheses cannot be rejected.
...
**Access the presentation here:** [Cocoa Artesanal - Market Strategic Presentation](https://docs.google.com/presentation/d/1Ky3EF1JdychHBuRP0t4RVjJtLIAAu0nnDUZdfav7fac/present?start=true)
