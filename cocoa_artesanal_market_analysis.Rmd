...
Early in the process, I identified export and import data as a strong alternative. Although trade flows differ from direct retail sales, they provide a reliable proxy for analyzing the broader market trends this project aims to evaluate. After selecting this source, I focused on identifying the specific product classifications required, which led me to the following HS codes aligned with the artisanal chocolate products:

* **180631**: Chocolate and other food preparations containing cocoa — filled (e.g., pralines, filled bars).
* **180632**: Chocolate and other food preparations containing cocoa — not filled (e.g., standard chocolate bars, chips).
